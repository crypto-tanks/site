    ...
    items: [
        {
            ...
            items: [
                ` ✔ Idea`,
                ` ✔ Search and involvement of specialists`,
                ` ✔ Development of the concept, rules, economy`,
                ` ✔ Technologies for implementation`,
                ` ✔ Preparation of work stages and marketing plan`
            ]
        },
        {
            date: 'January, 2022',
            items: [
                ` ✔ Contract development for NFT items`,
        ...
        },
        {
            date: 'February, 2022',
            items: [
                ` Деп Dispatch of prepared contracts to the MAINET network`,
                ` Привлечение Attracting players and investors from similar projects`,
                ` ⏱ Pre-sale of NFT and collection of liquidity for the token`,
                ` ⏱ Launching the first dev version for testing within the team`,
                ` ⏱ Full load testing of the game, vulnerability search`
            ]
        },
        {
            date: 'March, 2022',
            items: [
                ` ⏱ Creating liquidity for the coin. Starting the game.`,
                ` ⏱ Collecting feedback, eliminating possible problems.`,
                ` ⏱ Discussion of the team mode of the game`,
                ` ⏱ Development of the concept, rules, economy`,
                ` ⏱ Preparation of work stages and marketing plan`
            ]
        }
